...
<head>
    ...
    <title>سامانه تنقیح قوانین</title>
        ...
        <div style="margin: 250px auto;" id="main2">
           ...
           <div  class="uk-card uk-card-default uk-card-body">
               <div class="row">
                   ...
                   <div class="col-md-9">
                       <h3 style="text-align: right;">اضافه کردن قانون جدید</h3>
                   </div>
                   <div class="col-md-1">
                   </div>
               </div>
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-9">
                           <div class="md-form form-group input-form">
                               ...
                               <select id="type" class="form-control" style="display:block!important; width: 85%; margin-right: 100px;">
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-9">
                           <div class="md-form form-group input-form">
                               ...
                               <select id="status" class="form-control" style="display:block!important; width: 85%; margin-right: 130px;">
