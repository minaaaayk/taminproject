...
<main>
    <div class="container-fluid mt-5" id="main-content">
        ...
        <div class="md-form form-group input-form">
            ...
            <label for="form91" data-error="wrong" data-success="right" dir="rtl">ایمیل</label>
        </div>
        <div class="md-form form-group input-form">
            <i class="fa fa-envelope prefix" style="display: block;"></i>
            <input type="email" id="form91" class="form-control" style="">
            <label for="form91" data-error="wrong" data-success="right" dir="rtl">ایمیل</label>
        </div>
...
<script>
    ...
    $('document').ready(function () {
        ...
        $('#myfile').on('change',function () {
            ...
            var uploadURI = "<?php echo base_url();?>users/index.php/upload/do_upload2";
